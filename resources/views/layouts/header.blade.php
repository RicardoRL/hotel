	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="{{route('hotel.rooms')}}" class="nav-link">Habitaciones</a></li>
	          <li class="nav-item"><a href="{{route('hotel.restaurant')}}" class="nav-link">Restaurante</a></li>
	          <li class="nav-item"><a href="{{route('hotel.about')}}" class="nav-link">Acerca de</a></li>
